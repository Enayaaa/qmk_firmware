...
#define GS_ENT G(S(KC_ENT))
#define CS_N C(S(US_N))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WORKSPACE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, GS_ENT,  XXXXXXX, XXXXXXX,                        XXXXXXX, XXXXXXX, CS_N,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, KC_LSFT, G(US_0),      GS_ENT,  XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
